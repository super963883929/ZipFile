...
import net.zip4j.io.outputstream.SplitOutputStream;
import net.zip4j.io.outputstream.ZipOutputStream;
...
import net.zip4j.tasks.RemoveFilesFromZipTask.RemoveFilesFromZipTaskParameters;
import net.zip4j.util.BitUtils;
...
import static net.zip4j.headers.HeaderUtil.getFileHeader;
import static net.zip4j.model.ZipParameters.SymbolicLinkAction.INCLUDE_LINK_AND_LINKED_FILE;
import static net.zip4j.model.ZipParameters.SymbolicLinkAction.INCLUDE_LINK_ONLY;
import static net.zip4j.model.enums.CompressionMethod.DEFLATE;
import static net.zip4j.model.enums.CompressionMethod.STORE;
import static net.zip4j.model.enums.EncryptionMethod.NONE;
import static net.zip4j.model.enums.EncryptionMethod.ZIP_STANDARD;
import static net.zip4j.progress.ProgressMonitor.Task.ADD_ENTRY;
import static net.zip4j.progress.ProgressMonitor.Task.CALCULATE_CRC;
import static net.zip4j.progress.ProgressMonitor.Task.REMOVE_ENTRY;
import static net.zip4j.util.CrcUtil.computeFileCrc;
import static net.zip4j.util.FileUtils.assertFilesExist;
import static net.zip4j.util.FileUtils.getRelativeFileName;
