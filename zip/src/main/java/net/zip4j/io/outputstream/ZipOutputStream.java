...
import net.zip4j.headers.FileHeaderFactory;
...
public class ZipOutputStream extends OutputStream {
  ...
  public ZipOutputStream(OutputStream outputStream, char[] password, Charset charset) throws IOException {
    this(outputStream,
            password,
            new Zip4jConfig(charset, InternalZipConstants.BUFF_SIZE, InternalZipConstants.USE_UTF8_FOR_PASSWORD_ENCODING_DECODING),
            new ZipModel());
  }
  ...
  private void verifyZipParameters(ZipParameters zipParameters) {
    ...
    if (zipParameters.getCompressionMethod() == CompressionMethod.STORE
        ...
        && !FileUtils.isZipEntryDirectory(zipParameters.getFileNameInZip())
