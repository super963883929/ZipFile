...
import net.zip4j.util.PasswordCallback;
...
public class ZipInputStream extends InputStream {
  ...
  public ZipInputStream(InputStream inputStream, char[] password, Charset charset) {
    this(inputStream, password, new Zip4jConfig(charset, InternalZipConstants.BUFF_SIZE, InternalZipConstants.USE_UTF8_FOR_PASSWORD_ENCODING_DECODING));
  }

  public ZipInputStream(InputStream inputStream, PasswordCallback passwordCallback, Charset charset) {
    this(inputStream, passwordCallback, new Zip4jConfig(charset, InternalZipConstants.BUFF_SIZE, InternalZipConstants.USE_UTF8_FOR_PASSWORD_ENCODING_DECODING));
  }
