...
public void setEncryptFiles(boolean encryptFiles) {
  ...
  /**
   * Returns true if net.zip4j is using unix mode as default. Returns False otherwise.
   * @return true if net.zip4j is using unix mode as default, false otherwise
   */
  ...
  /**
   * When set to true, net.zip4j uses unix mode as default when generating file headers.
   * @param unixMode
   */
